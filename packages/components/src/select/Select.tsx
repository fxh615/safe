...
import type { SelectProps as RcSelectProps } from '@/_rc/Select';
import RcSelect, { BaseSelectRef, OptGroup, Option } from '@/_rc/Select';
import type { OptionProps } from '@/_rc/Select/Option';
import type { BaseOptionType, DefaultOptionType } from '@/_rc/Select/Select';
...
> extends Omit<RcSelectProps<ValueType, OptionType>, 'mode'> {
  ...
  size?: SizeType;
  disabled?: boolean;
  mode?: 'checkbox' | 'multiple' | 'tags' | 'SECRET_COMBOBOX_MODE_DO_NOT_USE';
  bordered?: boolean;
}
