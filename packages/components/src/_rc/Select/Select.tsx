...
export type Mode = 'combobox' | 'multiple' | 'tags' | 'checkbox';
...
const Select = React.forwardRef(
  (props: SelectProps<any, DefaultOptionType>, ref: React.Ref<BaseSelectRef>) => {
    ...
    const parsedOptions = useOptions(
      ...
      children,
      mergedFieldNames,
      optionFilterProp as string,
      optionLabelProp as string,
    );
    ...
    // ======================= Accessibility ========================
    const [activeValue, setActiveValue] = React.useState<string>(null as unknown as string);
    ...
    const onInternalSelect = useRefFunc<OnInternalSelect>((val, info) => {
      ...
      if (mergedSelect) {
        ...
        cloneValues = mergedValues.filter((v: LabelInValueType) => v.value !== val);
      }

      // cloneValues = cloneValues.filter((v: any) => !!v || !!v.value);
    ...
    const onInternalSearch: BaseSelectProps['onSearch'] = (searchText, info) => {
      ...
      setActiveValue(null as unknown as string);
