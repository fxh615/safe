...
export default function renderSwitcherIcon(
  ...
  const switcher: any = typeof switcherIcon === 'function' ? switcherIcon(treeNodeProps) : switcherIcon;

  if (isValidElement(switcher)) {
    return cloneElement(switcher, {
      className: classNames((switcher.props as any).className || '', switcherCls),
    });
  }
