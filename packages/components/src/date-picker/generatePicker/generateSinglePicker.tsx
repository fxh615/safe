...
import type { CommonPickerMethods, DatePickRef } from './interface';
...
export default function generatePicker<DateType>(generateConfig: GenerateConfig<DateType>) {
  ...
  function getPicker<InnerPickerProps extends DatePickerProps>(
    ...
    const Picker = forwardRef<DatePickRef<DateType> | CommonPickerMethods, InnerPickerProps>(
      (props, ref) => {
        ...
        return (
          // <LocaleReceiver<any> componentName="DatePicker" defaultLocale={enUS}>
          <LocaleReceiver<any> componentName="DatePicker">
  ...
  const QuarterPicker = getPicker<PickerTimeProps<DateType>>(
    'quarter',
    'QuarterPicker',
  );
