...
class AffixC extends React.Component<InternalAffixProps, AffixState> {
    ...
    return (
      ...
      >
        <div {...props} ref={this.savePlaceholderNode}>
          ...
          <AffixWrap className={className} ref={this.saveFixedNode} style={affixStyle}>
            <ResizeObserver
              onResize={() => {
                this.updatePosition();
              }}
...
// just use in test
export type InternalAffixClass = AffixC;

const Affix = React.forwardRef<AffixC, AffixProps>((props, ref) => {
  ...
  return <AffixC {...affixProps} ref={ref} />;
});
