...
class InternalSpin extends React.Component<SpinClassProps, SpinState> {
  static defaultProps = {
    spinning: true,
  ...
  renderSpin = ({ direction }: ConfigConsumerProps) => {
    ...
    if (this.isNestedPattern()) {
      ...
      return (
        <div {...divProps} className={classNames(`${prefixCls}-nested-loading`, wrapperClassName)} ref={ref}>
