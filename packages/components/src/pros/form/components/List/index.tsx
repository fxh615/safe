...
import { ProFormContext } from '@/pros/utils';
import ConfigProvider from '@/config-provider';
import Form from '@/form';
import type { LabelTooltipType } from '@/form/FormItemLabel';
import type { FormListFieldData, FormListOperation, FormListProps } from '@/form/FormList';
...
function ProFormList<T>(props: ProFormListProps<T>) {
  ...
  const proFormContext: any = useContext(ProFormContext);
