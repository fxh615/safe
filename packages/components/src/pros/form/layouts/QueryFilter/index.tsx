...
import { isBrowser, useMountMergeState } from '@/pros/utils';
...
import type { FormInstance, FormProps } from '@/form/Form';
...
const CONFIG_SPAN_BREAKPOINTS: Record<string, number> = {
  xs: 513,
  sm: 513,
  md: 785,
  lg: 992,
