...
// import type { IntlType } from '@/pros/provider';
import { useIntl } from '@/pros/provider';
import { isDeepEqualReact, omitUndefined } from '@/pros/utils';
import type { ColumnType as TableColumnType } from '@/table';
import Tooltip from '@/tooltip';
import type { LabelTooltipType } from '@/form/FormItemLabel';
...
function renderDefaultOption<T>(
  ...
  return Object.keys(options)
    ...
    .map((key: string) => {
      ...
      const optionItem = (getButtonText(defaultOptions) as any)[key];
      if (optionItem) {
        return (
          <span key={key} onClick={onClick}>
