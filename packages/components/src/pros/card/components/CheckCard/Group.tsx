import { useMountMergeState } from '@/pros/utils';
...
const CheckCardGroup: React.FC<CheckCardGroupProps> = (props: any) => {
  const {
  ...
  const domProps = omit(['children', 'defaultValue', 'value', 'disabled', 'size'], restProps);
